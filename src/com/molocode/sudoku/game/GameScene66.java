...
public class GameScene66 extends BaseSudokuScene {
	...
	public GameScene66(Activity activity) {
		super(activity);
	...
	private void initSprite() {
		...
		chessboard66Sprite.initCells(BaseBoard.getCellMap(examination
				.getQuestions()));
	...
	public void updateUiSuccessGame() {
		...
		Log.i("com.poxiao.suduko", " GameScene66 degreeId=" + degreeId
